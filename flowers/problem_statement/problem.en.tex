...
\begin{figure}[h]
  ...
  \caption*{The flowers in the example before any cutting. One can check that no
...
\begin{figure}[h]
  ...
  \caption*{The flowers in the example after the cutting have $2$ connections
  less. The connection between $1$ and $2$ can regrow because flowers $1$ and
  $2$ are both connected to flowers $4$ and $5$. Similarly, the connection
  between $4$ and $5$ can regrow because flowers $4$ and $5$ are both connected
  to flowers $1$ and $2$.}
\end{figure}
