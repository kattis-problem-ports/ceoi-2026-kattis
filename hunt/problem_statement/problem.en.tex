...
\section*{Example}
The sample interaction below is one treasure hunt on a $4 \times 4$ grid holding a
single chest, which sits at $(3, 2)$: the calls your program makes into the library
and the values the library gives back. None of it passes through standard input or
standard output, these are ordinary function calls. The attachment
\texttt{sample.in} describes this very hunt, so \texttt{InitFromFile} will replay
it for you locally.
