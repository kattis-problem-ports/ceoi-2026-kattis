...
\begin{tabular}{| r | c | l | l |}
  ...
  $0$  &            & \texttt{=}                     & (empty)          \\ \hline
  $1$  & \texttt{Y} & \texttt{=}                     & \texttt{-}       \\ \hline
  $2$  & \texttt{P} & \texttt{=-}                    & \texttt{-}       \\ \hline
  $3$  & \texttt{Y} & \texttt{=-}                    & \texttt{--}      \\ \hline
  $4$  & \texttt{P} & \texttt{-=--}                  & \texttt{--}      \\ \hline
  $5$  & \texttt{h} & \texttt{=---}                  & \texttt{--}      \\ \hline
  $6$  & \texttt{P} & \texttt{-=----}                & \texttt{--}      \\ \hline
  $7$  & \texttt{Y} & \texttt{-=----}                & \texttt{-----}   \\ \hline
  $8$  & \texttt{P} & \texttt{-----=-----}           & \texttt{-----}   \\ \hline
  $9$  & \texttt{P} & \texttt{---------=------}      & \texttt{-----}   \\ \hline
  $10$ & \texttt{P} & \texttt{-------------=-------} & \texttt{-----}   \\ \hline
\end{tabular}
